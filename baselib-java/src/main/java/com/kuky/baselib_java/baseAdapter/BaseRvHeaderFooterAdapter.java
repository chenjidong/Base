package com.kuky.baselib_java.baseAdapter;
...
public abstract class BaseRvHeaderFooterAdapter<T> extends RecyclerView.Adapter<BaseRvHeaderFooterAdapter.BaseHeaderFooterHolder> {
    ...
    @Override
    public BaseHeaderFooterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public int getItemViewType(int position) {
        ...
        else if (isFooterBinding(position)) return mFooterBindings.keyAt(position - getHeaderCount() - getDataCount());
