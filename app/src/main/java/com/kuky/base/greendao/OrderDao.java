...
public class OrderDao extends AbstractDao<Order, Long> {
    ...
    public static class Properties {
        ...
        public final static Property UniqueId = new Property(4, String.class, "uniqueId", false, "UNIQUE_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORDER\" (" + //
                ...
                "\"ORDER_NAME\" TEXT NOT NULL ," + // 2: orderName
                "\"PRICE\" REAL NOT NULL ," + // 3: price
                "\"UNIQUE_ID\" TEXT UNIQUE );"); // 4: uniqueId
    }
    ...
    public Order readEntity(Cursor cursor, int offset) {
        Order entity = new Order( //
            ...
            cursor.getString(offset + 2), // orderName
            cursor.getDouble(offset + 3), // price
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4) // uniqueId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Order entity, int offset) {
        ...
        entity.setOrderName(cursor.getString(offset + 2));
        entity.setPrice(cursor.getDouble(offset + 3));
        entity.setUniqueId(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
     }
