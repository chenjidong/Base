...
import com.kuky.looppicker.listener.CustomListener;
import com.kuky.looppicker.loopview.LoopView;
import com.kuky.looppicker.view.BasePickerView;
import com.kuky.looppicker.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private int option2;
    private int option3;
    private LoopView.DividerType dividerType;//分隔线类型
    ...
    public static class Builder {
        private int layoutRes = R.layout.picker_view_options;
        private CustomListener customListener;
         ...
         * @param dividerType
         */
        public Builder setDividerType(LoopView.DividerType dividerType) {
