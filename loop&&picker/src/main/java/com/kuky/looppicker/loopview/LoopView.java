...
import com.kuky.looppicker.R;
import com.kuky.looppicker.adapter.WheelAdapter;
import com.kuky.looppicker.listener.OnItemSelectedListener;
import com.kuky.looppicker.model.IPickerViewData;
...
public class LoopView extends View {
    ...
    public LoopView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.picker_view_picker_view_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.picker_view_picker_view_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.picker_view_picker_view_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.picker_view_picker_view_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.picker_view_picker_view_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
        judgeLineSpace();
